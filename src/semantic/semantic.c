...
static cct_sem_builtin_spec_t specs[654];
    ...
    if (!initialized) {
        ...
        specs[604].name = "cct_svc_civitas_build_request"; specs[604].min_args = 1; specs[604].variadic = false;
        specs[605].name = "cct_svc_civitas_req_method"; specs[605].min_args = 2; specs[605].variadic = false;
        specs[606].name = "cct_svc_civitas_req_path"; specs[606].min_args = 2; specs[606].variadic = false;
        specs[607].name = "cct_svc_civitas_req_query"; specs[607].min_args = 2; specs[607].variadic = false;
        specs[608].name = "cct_svc_civitas_req_host"; specs[608].min_args = 2; specs[608].variadic = false;
        specs[609].name = "cct_svc_civitas_req_body"; specs[609].min_args = 2; specs[609].variadic = false;
        specs[610].name = "cct_svc_civitas_req_body_len"; specs[610].min_args = 0; specs[610].variadic = false;
        specs[611].name = "cct_svc_civitas_req_header"; specs[611].min_args = 3; specs[611].variadic = false;
        specs[612].name = "cct_svc_civitas_req_id"; specs[612].min_args = 2; specs[612].variadic = false;
        specs[613].name = "cct_svc_civitas_res_html"; specs[613].min_args = 2; specs[613].variadic = false;
        specs[614].name = "cct_svc_civitas_res_json"; specs[614].min_args = 2; specs[614].variadic = false;
        specs[615].name = "cct_svc_civitas_res_text"; specs[615].min_args = 2; specs[615].variadic = false;
        specs[616].name = "cct_svc_civitas_res_redirect"; specs[616].min_args = 1; specs[616].variadic = false;
        specs[617].name = "cct_svc_civitas_res_not_found"; specs[617].min_args = 0; specs[617].variadic = false;
        specs[618].name = "cct_svc_civitas_res_error"; specs[618].min_args = 1; specs[618].variadic = false;
        specs[619].name = "cct_svc_civitas_res_set_header"; specs[619].min_args = 2; specs[619].variadic = false;
        specs[620].name = "cct_svc_civitas_res_send"; specs[620].min_args = 0; specs[620].variadic = false;
        specs[621].name = "cct_svc_kv_init"; specs[621].min_args = 0; specs[621].variadic = false;
        specs[622].name = "cct_svc_kv_set"; specs[622].min_args = 2; specs[622].variadic = false;
        specs[623].name = "cct_svc_kv_get"; specs[623].min_args = 3; specs[623].variadic = false;
        specs[624].name = "cct_svc_kv_del"; specs[624].min_args = 1; specs[624].variadic = false;
        specs[625].name = "cct_svc_kv_set_int"; specs[625].min_args = 2; specs[625].variadic = false;
        specs[626].name = "cct_svc_kv_get_int"; specs[626].min_args = 2; specs[626].variadic = false;
        specs[627].name = "cct_svc_kv_increment"; specs[627].min_args = 1; specs[627].variadic = false;
        specs[628].name = "cct_svc_kv_count"; specs[628].min_args = 0; specs[628].variadic = false;
        specs[629].name = "cct_svc_static_count"; specs[629].min_args = 0; specs[629].variadic = false;
        specs[630].name = "cct_svc_static_find"; specs[630].min_args = 1; specs[630].variadic = false;
        specs[631].name = "cct_svc_static_path"; specs[631].min_args = 3; specs[631].variadic = false;
        specs[632].name = "cct_svc_static_ctype"; specs[632].min_args = 3; specs[632].variadic = false;
        specs[633].name = "cct_svc_static_len"; specs[633].min_args = 1; specs[633].variadic = false;
        specs[634].name = "cct_svc_static_data"; specs[634].min_args = 3; specs[634].variadic = false;
        specs[635].name = "cct_svc_http_server_conn_requests"; specs[635].min_args = 0; specs[635].variadic = false;
        specs[636].name = "cct_svc_http_server_keepalive_enabled"; specs[636].min_args = 0; specs[636].variadic = false;
        specs[637].name = "cct_svc_http_server_set_keepalive"; specs[637].min_args = 1; specs[637].variadic = false;
        specs[638].name = "cct_svc_http_server_consume"; specs[638].min_args = 1; specs[638].variadic = false;
        specs[639].name = "cct_svc_http_server_pending_len"; specs[639].min_args = 0; specs[639].variadic = false;
        specs[640].name = "cct_svc_dhcp_acquire"; specs[640].min_args = 1; specs[640].variadic = false;
        specs[641].name = "cct_svc_dhcp_lease_ip"; specs[641].min_args = 1; specs[641].variadic = false;
        specs[642].name = "cct_svc_dhcp_lease_gw"; specs[642].min_args = 1; specs[642].variadic = false;
        specs[643].name = "cct_svc_dhcp_lease_mask"; specs[643].min_args = 1; specs[643].variadic = false;
        specs[644].name = "cct_svc_dhcp_lease_time"; specs[644].min_args = 0; specs[644].variadic = false;
        specs[645].name = "cct_svc_dhcp_using_fallback"; specs[645].min_args = 0; specs[645].variadic = false;
        specs[646].name = "cct_svc_asset_mount"; specs[646].min_args = 0; specs[646].variadic = false;
        specs[647].name = "cct_svc_asset_exists"; specs[647].min_args = 1; specs[647].variadic = false;
    ...
    specs[604].return_type = &sem->type_nihil;
    specs[605].return_type = &sem->type_nihil;
    specs[606].return_type = &sem->type_nihil;
    specs[607].return_type = &sem->type_nihil;
    specs[608].return_type = &sem->type_nihil;
    specs[609].return_type = &sem->type_nihil;
    specs[610].return_type = &sem->type_rex;
    specs[611].return_type = &sem->type_nihil;
    specs[612].return_type = &sem->type_nihil;
    specs[613].return_type = &sem->type_nihil;
    specs[614].return_type = &sem->type_nihil;
    specs[615].return_type = &sem->type_nihil;
    specs[616].return_type = &sem->type_nihil;
    specs[617].return_type = &sem->type_nihil;
    specs[618].return_type = &sem->type_nihil;
    specs[619].return_type = &sem->type_nihil;
    specs[620].return_type = &sem->type_nihil;
    specs[621].return_type = &sem->type_nihil;
    specs[622].return_type = &sem->type_nihil;
    specs[623].return_type = &sem->type_nihil;
    specs[624].return_type = &sem->type_nihil;
    specs[625].return_type = &sem->type_nihil;
    specs[626].return_type = &sem->type_rex;
    specs[627].return_type = &sem->type_nihil;
    specs[628].return_type = &sem->type_rex;
    specs[629].return_type = &sem->type_rex;
    specs[630].return_type = &sem->type_rex;
    specs[631].return_type = &sem->type_nihil;
    specs[632].return_type = &sem->type_nihil;
    specs[633].return_type = &sem->type_rex;
    specs[634].return_type = &sem->type_nihil;
    specs[635].return_type = &sem->type_rex;
    specs[636].return_type = &sem->type_rex;
    specs[637].return_type = &sem->type_nihil;
    specs[638].return_type = &sem->type_nihil;
    specs[639].return_type = &sem->type_rex;
    specs[640].return_type = &sem->type_rex;
    specs[641].return_type = &sem->type_nihil;
    specs[642].return_type = &sem->type_nihil;
    specs[643].return_type = &sem->type_nihil;
    specs[644].return_type = &sem->type_rex;
    specs[645].return_type = &sem->type_rex;
    specs[646].return_type = &sem->type_rex;
    specs[647].return_type = &sem->type_rex;
