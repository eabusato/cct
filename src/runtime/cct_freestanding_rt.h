...
extern void cct_svc_civitas_build_request(long long req_number);
extern void cct_svc_civitas_req_method(void *dst, long long max_len);
extern void cct_svc_civitas_req_path(void *dst, long long max_len);
extern void cct_svc_civitas_req_query(void *dst, long long max_len);
extern void cct_svc_civitas_req_host(void *dst, long long max_len);
extern void cct_svc_civitas_req_body(void *dst, long long max_len);
extern long long cct_svc_civitas_req_body_len(void);
extern void cct_svc_civitas_req_header(const char *name, void *dst, long long max_len);
extern void cct_svc_civitas_req_id(void *dst, long long max_len);
extern void cct_svc_civitas_res_html(long long status, const char *body);
extern void cct_svc_civitas_res_json(long long status, const char *json);
extern void cct_svc_civitas_res_text(long long status, const char *text);
extern void cct_svc_civitas_res_redirect(const char *location);
extern void cct_svc_civitas_res_not_found(void);
extern void cct_svc_civitas_res_error(const char *msg);
extern void cct_svc_civitas_res_set_header(const char *name, const char *value);
extern void cct_svc_civitas_res_send(void);
extern void cct_svc_kv_init(void);
extern void cct_svc_kv_set(const char *key, const char *value);
extern void cct_svc_kv_get(const char *key, void *dst, long long max_len);
extern void cct_svc_kv_del(const char *key);
extern void cct_svc_kv_set_int(const char *key, long long value);
extern long long cct_svc_kv_get_int(const char *key, long long fallback);
extern void cct_svc_kv_increment(const char *key);
extern long long cct_svc_kv_count(void);
extern long long cct_svc_static_count(void);
extern long long cct_svc_static_find(const char *path);
extern void cct_svc_static_path(long long idx, void *dst, long long max_len);
extern void cct_svc_static_ctype(long long idx, void *dst, long long max_len);
extern long long cct_svc_static_len(long long idx);
extern void cct_svc_static_data(long long idx, void *dst, long long max_len);
extern long long cct_svc_http_server_conn_requests(void);
extern long long cct_svc_http_server_keepalive_enabled(void);
extern void cct_svc_http_server_set_keepalive(long long enabled);
extern void cct_svc_http_server_consume(long long consumed_len);
extern long long cct_svc_http_server_pending_len(void);
extern long long cct_svc_dhcp_acquire(long long timeout_ms);
extern void cct_svc_dhcp_lease_ip(void *dst4);
extern void cct_svc_dhcp_lease_gw(void *dst4);
extern void cct_svc_dhcp_lease_mask(void *dst4);
extern long long cct_svc_dhcp_lease_time(void);
extern long long cct_svc_dhcp_using_fallback(void);
extern long long cct_svc_asset_mount(void);
extern long long cct_svc_asset_exists(const char *path);
extern long long cct_svc_asset_len(const char *path);
extern long long cct_svc_asset_read(const char *path, void *dst, long long max_len);
extern const char *cct_svc_asset_content_type(const char *path);
